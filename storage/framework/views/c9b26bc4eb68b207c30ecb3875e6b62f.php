<?php $__env->startSection('pageTitle', 'Редакция на протокол'); ?>
        ...
        <div class="container py-5 mt-5">
            ...
            <div id="new_protocol_container" class="row align-items-center py-5 mt-5">
                <div class="col-md-12 mb-5 mb-md-0" id="protocolContainer">
                    ...
                    <form action="<?php echo e(route('protocols.edit', $invitation->inv_key)); ?>" id="protocolForm" method="POST" class="hero-form p-5">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control bs-timepicker" tabindex="2"
                                            value="<?php echo e($protocol->end_time); ?>" name="end_time" id="end_time">
                                </div>
                                <div class="mb-3">
                                    <label for="minuteman" class="form-label mb-0">Протоколчик</label>
                                    <input type="text" class="form-control" tabindex="3"
                                            value="<?php echo e($protocol->minuteman); ?>" name="minuteman" id="minuteman">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" tabindex="4"
                                        value="<?php echo e($protocol->meetQuorum1); ?>" name="meetQuorum1" id="meetQuorum1">
                                </div>
                                <div class="mb-3">
                                    <label for="meetQuorum2" class="form-label mb-0">Кворум час 2 (%)</label>
                                    <input type="number" class="form-control" tabindex="5"
                                            value="<?php echo e($protocol->meetQuorum2); ?>" name="meetQuorum2" id="meetQuorum2">
                                </div>
                                <div class="mb-3">
                        ...
                        <h4 class="mt-3">Присъстващи</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <textarea class="form-control" tabindex="5" rows="6" name="participants" id="participants">
                                <?php echo e(implode(PHP_EOL, $participants)); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ramona/PhpstormProjects/QuestDoc/resources/views/protocols/edit.blade.php ENDPATH**/ ?>