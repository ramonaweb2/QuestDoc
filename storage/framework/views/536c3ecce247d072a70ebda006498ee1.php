...
<body>
    ...
    <h4 class="text-center">
        ...
        От Управителя на ЕС <?php echo e($invitation['manager']); ?>, на основание <?php echo e($invitation['reason']); ?><br/>
        ЗА ОБЩО СЪБРАНИЕ НА СОБСТВЕНИЦИТЕ НА ЕТАЖНА СОБСТВЕНОСТ с адрес:<br/>
        <?php echo e($invitation['address']); ?><br/>
    </h4>

    <p>което ще се проведе:</p>
    <p>на <?php echo e($invitation['meet_date']); ?>г от <?php echo e($invitation['meet_time']); ?> часа 
        на <?php echo e($invitation['location']); ?></p>
    <p>С ДНЕВЕН РЕД:</p>
    <ul>
    ...
    <p class="mt-5">Тази покана е поставена на видно място - <?php echo e($invitation['stick_place']); ?> 
...
</html><?php /**PATH /home/ramona/PhpstormProjects/QuestDoc/resources/views/invitations/invitation.blade.php ENDPATH**/ ?>