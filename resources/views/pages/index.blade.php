        ...
        <div class="container py-5 mt-5">
            <div id="select_container" class="row align-items-center py-5 mt-5">
                <div class="col-md-5 offset-md-1 p-5" style="background: rgba(255, 255, 255, 0.90)">
                    ...
                    <a href="{{ route('invitations.show') }}" class="btn btn-primary btn-lg">Старо</a>
                </div>
            </div>
            ...
            <div id="new_invitation_container" class="row align-items-center py-5 mt-5 d-none">
                <div class="col-md-12" id="meetContainer">
                    ...
                    <form action="{{ route('invitations.store') }}" id="meetForm" method="get" class="hero-form p-5">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="date" class="form-control"
                                    value="{{old('meet_date')}}" name="meet_date" id="meet_date">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control bs-timepicker"
                                    value="{{ old('meet_time') }}" name="meet_time" id="meet_time">
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ old('stick_place') }}"
