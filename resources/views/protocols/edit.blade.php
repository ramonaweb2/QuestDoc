@extends('layout')
@section('pageTitle', 'Редакция на протокол')
        ...
        <div class="container py-5 mt-5">
            ...
            <div id="new_protocol_container" class="row align-items-center py-5 mt-5">
                <div class="col-md-12 mb-5 mb-md-0" id="protocolContainer">
                    ...
                    <form action="{{ route('protocols.edit', $invitation->inv_key) }}" id="protocolForm" method="POST" class="hero-form p-5">
                        @csrf
                        @method('PUT')
                        <h3>ПРОТОКОЛ</h3>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control bs-timepicker" tabindex="2"
                                            value="{{ $protocol->end_time }}" name="end_time" id="end_time">
                                </div>
                                <div class="mb-3">
                                    <label for="minuteman" class="form-label mb-0">Протоколчик</label>
                                    <input type="text" class="form-control" tabindex="3"
                                            value="{{ $protocol->minuteman }}" name="minuteman" id="minuteman">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" tabindex="4"
                                        value="{{ $protocol->meetQuorum1 }}" name="meetQuorum1" id="meetQuorum1">
                                </div>
                                <div class="mb-3">
                                    <label for="meetQuorum2" class="form-label mb-0">Кворум час 2 (%)</label>
                                    <input type="number" class="form-control" tabindex="5"
                                            value="{{ $protocol->meetQuorum2 }}" name="meetQuorum2" id="meetQuorum2">
                                </div>
                                <div class="mb-3">
